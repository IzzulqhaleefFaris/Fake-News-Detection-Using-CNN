...
max_vocab_rnn = 10000
maxlen_rnn = 256
tokenizer_rnn_file = 'C://Users//user//Desktop//Fake_News_Detection//Finalize//tokenizer_rnn.pickle'

with open(tokenizer_rnn_file, 'rb') as tokenizer_file:
    tokenizer_rnn = pickle.load(tokenizer_file)

model = load_model(
    "C://Users//user//Desktop//Fake_News_Detection//Finalize//RNN.h5"
)
...
def predict():
    try:
        ...
        tokenized_data = tokenizer_rnn.texts_to_sequences([processed_data])

        # Debugging information
        print(f"Tokenized Data: {tokenized_data}")

        padded_data = pad_sequences(tokenized_data, maxlen=maxlen_rnn)
